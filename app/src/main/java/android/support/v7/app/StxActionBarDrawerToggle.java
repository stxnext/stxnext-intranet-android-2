 ...
 * ActionBar theme.
 */
public class StxActionBarDrawerToggle implements DrawerLayout.DrawerListener {
     ...
     *                                  for accessibility
     */
    public StxActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,
     ...
     * <p>
     * Please use {@link #StxActionBarDrawerToggle(Activity, DrawerLayout, int, int)} if you are
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> StxActionBarDrawerToggle(Activity activity, Toolbar toolbar,
